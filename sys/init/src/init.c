...
#if MN_CFG_MSYS_1_BLOCK_COUNT > 0
#define SYSINIT_MSYS_1_MEMBLOCK_SIZE    OS_ALIGN(MN_CFG_MSYS_1_BLOCK_SIZE, 4)
#define SYSINIT_MSYS_1_MEMPOOL_SIZE     \
    OS_MEMPOOL_SIZE(MN_CFG_MSYS_1_BLOCK_COUNT, SYSINIT_MSYS_1_MEMBLOCK_SIZE)
...
#if MN_CFG_MSYS_2_BLOCK_COUNT > 0
#define SYSINIT_MSYS_2_MEMBLOCK_SIZE    OS_ALIGN(MN_CFG_MSYS_2_BLOCK_SIZE, 4)
#define SYSINIT_MSYS_2_MEMPOOL_SIZE     \
    OS_MEMPOOL_SIZE(MN_CFG_MSYS_2_BLOCK_COUNT, SYSINIT_MSYS_2_MEMBLOCK_SIZE)
...
#if MN_CFG_MSYS_3_BLOCK_COUNT > 0
#define SYSINIT_MSYS_3_MEMBLOCK_SIZE    OS_ALIGN(MN_CFG_MSYS_3_BLOCK_SIZE, 4)
#define SYSINIT_MSYS_3_MEMPOOL_SIZE     \
    OS_MEMPOOL_SIZE(MN_CFG_MSYS_3_BLOCK_COUNT, SYSINIT_MSYS_3_MEMBLOCK_SIZE)
...
#if MN_CFG_MSYS_4_BLOCK_COUNT > 0
#define SYSINIT_MSYS_4_MEMBLOCK_SIZE    OS_ALIGN(MN_CFG_MSYS_4_BLOCK_SIZE, 4)
#define SYSINIT_MSYS_4_MEMPOOL_SIZE     \
    OS_MEMPOOL_SIZE(MN_CFG_MSYS_4_BLOCK_COUNT, SYSINIT_MSYS_4_MEMBLOCK_SIZE)
...
#if MN_CFG_MSYS_5_BLOCK_COUNT > 0
#define SYSINIT_MSYS_5_MEMBLOCK_SIZE    OS_ALIGN(MN_CFG_MSYS_5_BLOCK_SIZE, 4)
#define SYSINIT_MSYS_5_MEMPOOL_SIZE     \
    OS_MEMPOOL_SIZE(MN_CFG_MSYS_5_BLOCK_COUNT, SYSINIT_MSYS_5_MEMBLOCK_SIZE)
